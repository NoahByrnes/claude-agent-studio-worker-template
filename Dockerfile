...
COPY ferry-monitor-daemon.sh /usr/local/bin/ferry-monitor-daemon
RUN chmod +x /usr/local/bin/wait-for-ferry /usr/local/bin/bc-ferries-book /usr/local/bin/test-playwright /usr/local/bin/ferry-monitor-daemon
